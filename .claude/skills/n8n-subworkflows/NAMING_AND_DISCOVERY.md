...
**This page is about workflow names, not node names.** Workflow names are searched
by humans and by `n8n_list_workflows`, so they stay readable with a verb-first
prefix. Node names are PascalCase because tools and code reference them; see
