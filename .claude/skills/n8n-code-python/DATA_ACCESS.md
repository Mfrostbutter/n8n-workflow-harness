...
> `GetToken`). Python always uses the bracket form, but PascalCase still removes
> the case-and-space mismatches that make `_node[...]` return nothing. Convention
> in **n8n-workflow-patterns**, Node naming.
